                ...
                <div
                    style={{
                        ...
                        border: isAdmin
                            ...
                            : '1px solid rgba(79,142,247,0.16)',
                        background: isAdmin
                            ? 'linear-gradient(135deg, rgba(248,113,113,0.10), rgba(255,255,255,0.02))'
                            : 'linear-gradient(135deg, rgba(79,142,247,0.12), rgba(255,255,255,0.02))',
                        ...
                        <div>
                            <div
                                style={{
                                    ...
                                    color: isAdmin ? '#f87171' : 'var(--accent)'
                                }}
                            >
                                {isAdmin ? <ShieldCheck size={13} /> : <Sparkles size={13} />}
                                {isAdmin ? 'Admin Module Access' : 'User Module Access'}
                            </div>
                            ...
                            >
                                {isAdmin
                                    ? `Manage campus facilities, monitor availability, update statuses, and maintain the resource catalogue efficiently. Welcome back${user?.name ? `, ${user.name}` : ''}.`
                                    : `Browse campus facilities, check availability, and explore bookable resources with a smooth user experience. Welcome${user?.name ? `, ${user.name}` : ''}.`}
                            </p>
                        </div>
